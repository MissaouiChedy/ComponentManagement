...
use SmartDev\MainBundle\Entity\NatureProduit;
use SmartDev\MainBundle\Form\NatureProduitType;
...
class DefaultController extends Controller {
	public function indexAction() {
		return $this
				->render('SmartDevMainBundle:Default:index.html.twig',
						array(
								'componentLink' => $this
										->generateUrl(
												"smart_dev_main_componentsDisplayPage"),
								'productLink' => $this
										->generateUrl(
												"smart_dev_main_productsDisplayPage")));
	}
	...
	public function ajouter_composantAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_composant.html.twig',
	...
	public function ajouter_produitAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_produit.html.twig',
						array('form' => $form->createView()));
	}
	...
	public function ajouter_licenceAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_licence.html.twig',
						array('form' => $form->createView()));
	}
	...
	public function ajouter_etatAction() {
		...
		return $this
				->render('SmartDevMainBundle:Default:ajouter_etat.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_nature_composantAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_nature_composant.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_nature_produitAction() {

		$natp = $this->getDoctrine()->getEntityManager();
		$natup = new NatureProduit;
		$form = $this->createForm(new NatureProduitType());
		$request = $this->getRequest();
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_nature_produit.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_version_produitAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_produit_version.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_composant_versionAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_composant_version.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_programme_produitAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_programme_produit.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_type_produitAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_type_produit.html.twig',
						array('form' => $form->createView()));
	}
	public function ajouter_type_composantAction() {
		...
		return $this
				->render(
						'SmartDevMainBundle:Default:ajouter_type_composant.html.twig',
						array('form' => $form->createView()));
	}
